...
\subsubsection{Types}
\infer[(Location)]{Γ|Σ \vdash loc(l): \on{Ref} T}{Σ(l) = T}
\infer[(Dereference)]{Γ|Σ \vdash deref(e): T}{Γ|Σ \vdash e : \on{Ref} T}
\infer[(Reference)]{Γ|Σ \vdash ref(e): \on{Ref} T}{Γ|Σ \vdash e : T}
\infer[(Assignment)]{Γ|Σ \vdash assign(e₁, e₂): Unit}{Γ|Σ \vdash e₁ : \on{Ref} T \hspace{1em} Γ|Σ \vdash e₂ : T}
